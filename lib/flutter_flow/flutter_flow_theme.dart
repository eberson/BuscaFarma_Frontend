...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFF5763C6);
  ...
  late Color platinum = const Color(0xFFE9E9E9);
  late Color myrtleGreen = const Color(0xFF397F7E);
  late Color lightBlue = const Color(0xFFAACCCB);
  late Color engineeringOrange = const Color(0xFFD60000);
